...
<body>
	...
	<div class="container">
		<div class="card mt-5 mb-5">
			<h5 class="card-header">Coach</h5>
			<div class="card-body">
				<h5 class="card-title text-center">Formulário de coachs</h5>
				<div class="row justify-content-center">
				<div class="col-sm-12 col-md-10 col-lg-8">
					<form action="ServletUpdateCoach?page=update" method="post">
						<div class="form-row">
						...
						<div class="form-row">
							...
							<div class="form-group col-sm-3">
								...
								<input type="text"
									class="form-control" id="inputCertificado" placeholder="Certificado" name="certificado" value="<%= request.getAttribute("certificado") %>" maxlength="100" required>
							</div>
						</div>
						<div class="form-row">
						...
						<input type="hidden" name="coachID" value="<%= request.getAttribute("coachID") %>">
