...
<body>
	...
	<div class="container">
		<div class="card mt-5 mb-5">
			...
			<div class="card-body">
				<h5 class="card-title text-center">Formulário de atletas</h5>
				<div class="row justify-content-center">
				<div class="col-sm-12 col-md-10 col-lg-8">
					<form action="ServletUpdateAtleta?page=update" method="post">
						<div class="form-row">
						...
						<div class="form-row">
							...
							<div class="form-group col-sm-3">
								...
								<select id="inputFunction" class="form-control" name="categoria">
									<option value="<%= request.getAttribute("categoria") %>" selected><%= request.getAttribute("categoria") %></option>
						...
						<input type="hidden" name="atletaID" value="<%= request.getAttribute("atletaID") %>">
