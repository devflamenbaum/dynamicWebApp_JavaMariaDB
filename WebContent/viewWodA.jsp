...
<body>
	...
	<% if(request.getSession().getAttribute("treino") == null){
		...
		out.print("<div class=\"form-row\"><div class=\"form-group col-sm-12\"><label for=\"inputDescription\">Descrição:</label> <textarea class=\"form-control\" id=\"inputDescription\" placeholder=\"Descrição\" name=\"description\" rows=\"10\" cols=\"20\" disabled>"+ treino.getDescricao()+"</textarea>");
